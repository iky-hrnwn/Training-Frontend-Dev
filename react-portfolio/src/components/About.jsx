...
export default function About() {
    return (
      <section className="h-auto bg-[#262622] text-[#F2F2EB]">
        <div className="container mx-auto px-3 py-2">
          <h1 className="font-bold text-8xl pt-25">ABOUT</h1>
          <img className="h-74 w-auto py-4" src="./assets/hero-image.png" alt="photo-profile" />
